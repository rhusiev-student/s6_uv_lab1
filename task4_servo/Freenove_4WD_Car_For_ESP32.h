...
void Servo_Sweep(int servo_id, int angle_start, int angle_end, int time);//Servo sweep function;
void Motor_Move(int m1_speed, int m2_speed, int m3_speed, int m4_speed, int time_per_degree);//A function to control the car motor
